    ...
    return (
        <form className={styles.calculationForm}>
            <div className={styles.formDiv}>
                ...
                <span>$</span>
                <input className={styles.formInput} type = "text" pattern = "[0-9]*" value = {subtotal} onChange = {e => {
            ...
            <div className={styles.formDiv}>
                ...
                <span>$</span>
                <input className={styles.formInput} type = "text" pattern = "[0-9]*" defaultValue = {tax} value = {tax} onChange = {e => setTax(e.target.value)} />
            </div>
            <div className={styles.formDiv}>
                <label className={styles.formLabel}> Tip (default 15%): </label>
                <span>$</span>
                <input className={styles.formInput} type = "text" pattern = "[0-9]*" defaultValue = {tip} value = {tip} onChange = {e => setTip(e.target.value)} />
            </div>
            <div className={styles.formDiv} id='itemList'>
                <label className={styles.formLabel}> Individual Cost: </label>
                <span>$</span>
                <input className={styles.formInput} type = "text" pattern = "[0-9]*" value = {individualCost} onChange = {e => setIndividualCost(e.target.value)} />
            </div>
            <div className={styles.formDiv}>
